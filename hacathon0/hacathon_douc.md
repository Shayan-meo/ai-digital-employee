...
Purpose 
Claude Code 
Active subscription (Pro or Use 
...
i. 
/Needs_Action/<domain>/, /Plans/<domain>/, 
...
Cloud writes updates to /Updates/ (or /Signals/), and Local merges them 
into Dashboard.md. 
...
### Cost Optimization - **Notion**: No team activity in 45 days. Cost: $15/month. - [ACTION] Cancel subscription? Move to /Pending_Approval 
...
30 min 
realpython.com/read-write-files-python 1 hour 
MCP Introduction 
modelcontextprotocol.io/introduction 
1 hour 
19 
Agent Skills 
platform.claude.com/docs/en/agents-a
...
Video 
Tutorial 
youtube.com/watch?v=0J2_YGuNrDo Video 
developers.google.com/gmail/api/quic
kstart 
